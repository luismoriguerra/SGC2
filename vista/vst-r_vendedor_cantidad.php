...
<html>
	...
	<script type="text/javascript" src="../javascript/dao/DAOcarrera.js"></script>
		...
		<script type="text/javascript" src="../javascript/js/js-r_vendedor_cantidad.js"></script>
			...
			<div class="cuerpo">
				...
				<div class="secc-der" id="secc-der">
                    ...
                    <div id="panel_matricula" style="display:block">
                        <div class="barra1"><i class="icon-gray icon-list-alt"></i> <b>REPORTE VENDEDOR CANTIDAD</b></div>         
                        <div class="cont-der">
							<div class="t-center">
