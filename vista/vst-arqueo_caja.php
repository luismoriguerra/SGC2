...
<html>
	<head>
		...
		<script type="text/javascript" src="../javascript/js/js-arqueo_caja.js"></script>
			...
			<div class="cuerpo">
				<div class="secc-izq" id="secc-izq" style="width:140px;">
					<ul class="lca" style="display:block">
                                            <li id="list_Arqueo Caja" onclick="sistema.activaPanel('list_Arqueo Caja','panel_Arqueo Caja')" class="active"><span><i class="icon-gray icon-download"></i> Arqueo Caja </span></li>
					</ul>
				</div>
