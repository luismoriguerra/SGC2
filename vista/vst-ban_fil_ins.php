...
<html>
	...
	<script type="text/javascript" src="../javascript/dao/DAOcarrera.js"></script>
		...
		<script type="text/javascript" src="../javascript/js/js-banco_asignacion.js"></script>
			...
			<div class="cuerpo">
				...
				<div class="secc-der" id="secc-der">
                    ...
                    <div id="panel_matricula" style="display:block">
                        <div class="barra1"><i class="icon-gray icon-list-alt"></i> <b>Asignacion de Filial Institucion a Cuentas<?   /*aqui va el titulo q presentara  */ ?></b></div>         
                        <div class="cont-der">
							<div class="t-center">
                                <div class="barra4 contentBarra t-blanco t-left"><i class="icon-white icon-th"></i>Asignacion</div>
                       
                                <!--Inicio tabla-->
                                <table style="width:90%">                                        
                                        <tr>
                                            <td class="t-left label input-large">Cuenta de Export. a Bancos: <br> <div id='nombre_ide' class='t-rojo'>.::Nuevo::.</div></td>
                                            <td class="t-left">
                                            <input type="text" id="txt_detalle_ex" onBlur='verificaNombre();' class="input-xxlarge">
                                            </td>
                                       </tr>
                                        <tr>
                                ...
                                <div style="margin:15px 0px 10px 0px;">
                                    ...
                                    <a id="btn_Generar" class="btn btn-azul sombra-3d t-blanco" href="javascript:void(0)">
                                        <i class="icon-white icon-download"></i>
                                        <span>Generar Asignación</span>
                                    </a>
                                </div>
                                <br>
