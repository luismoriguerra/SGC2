...
<html>
	<head>
		...
		<script src="../javascript/jqGrid/JQGridCencap.js"></script>
                <script src="../javascript/dao/DAOcencap.js"></script>
                <script src="../javascript/js/js-m_cencap.js"></script>
			...
			<div class="cuerpo">
				...
				<div class="secc-der" id="secc-der">
                    ...
                    <div id="panel_matricula" style="display:block">
    					<div class="barra1"><i class="icon-gray icon-list-alt"></i> <b>Mantenimiento Centro(s) de captación <? /*aqui va el titulo q presentara  */ ?></b></div>         
                        <div class="cont-der">
			<? /*
