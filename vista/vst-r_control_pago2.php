...
<html>
	...
	<script type="text/javascript" src="../javascript/dao/DAOcarrera.js"></script>
		...
		<script type="text/javascript" src="../javascript/js/js-r_control_pago2.js"></script>
			...
			<div class="cuerpo">
				...
				<div class="secc-der" id="secc-der">
                    ...
                    <div id="panel_matricula" style="display:block">
                        <div class="barra1"><i class="icon-gray icon-list-alt"></i> <b>CONTROL DE PAGOS DE MATRICULADOS POR MEDIO DE CAPTACIÓN</b></div>         
                        <div class="cont-der">
							<div class="t-center">
                                ...
                                <table style="width:90%">
                                       ...
                                       <tr>
                                            <td class="t-left label input-large">Fechas de Digitación:</td>
                                            <td class="t-left">
                                            Del:
                                            <input type="text" id="txt_fecha_inicio_dig" class="input-medium" value="">
                                            Al
                                            <input type="text" id="txt_fecha_fin_dig" class="input-medium" value="">
                                            </td>
                                       </tr>                                       
                                    </table>
                                <!--fin talba-->                                
