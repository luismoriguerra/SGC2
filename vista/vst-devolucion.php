...
<head>
    ...
    <title>Telesup | Reporte de Devoluciones</title>
    ...
    <script type="text/javascript" src="../javascript/js/js-devoluciones.js"></script>
    ...
    <div class="cuerpo">
        ...
        <div class="secc-der" id="secc-der">
            ...
            <div id="panel_matricula" style="display:block">
                <div class="barra1"><i class="icon-gray icon-list-alt"></i> <b>Reporte de Devoluciones <?   /*aqui va el titulo q presentara  */ ?></b></div>
                <div class="cont-der">
                    <div class="t-center">
