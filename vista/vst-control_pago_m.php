...
<html>
	<head>
		...
		<title>SGC | Resumen de control de pagos</title>
		...
		<script type="text/javascript" src="../javascript/js/js-control_pago_m.js"></script>
			...
			<div class="cuerpo">
				...
				<div class="secc-der" id="secc-der">
                    ...
                    <div id="panel_matricula" style="display:block">
                        <div class="barra1"><i class="icon-gray icon-list-alt"></i> <b>CONTROL DE PAGOS DE MATRICULADOS<?   /*aqui va el titulo q presentara  */ ?></b></div>         
                        <div class="cont-der">
							<div class="t-center">
