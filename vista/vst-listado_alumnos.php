...
<html>
	...
	<script type="text/javascript" src="../javascript/dao/DAOcarrera.js"></script>
        ...
        <script type="text/javascript" src="../javascript/js/js-listado_alumnos.js"></script>
			...
			<div class="cuerpo">
				...
				<div class="secc-der" id="secc-der">
                    ...
                    <div id="panel_matricula" style="display:block">
                        <div class="barra1"><i class="icon-gray icon-list-alt"></i> <b>LISTADO DE ALUMNOS <?   /*aqui va el titulo q presentara  */ ?></b></div>         
                        <div class="cont-der">
			<div class="t-center">
...
<!--                                            <td class="t-left label">Tipo Carrera:</td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="t-left label">PAGANTE/DEUDOR:</td>
                                            <td>
                                                <select id="slct_tipopagante" class="input-medium">
                                                    <option value="">--Selecione--</option>
                                                    <option value="C">Pagante</option>
                                                    <option value="P">Deudor</option>
                                                </select>
                                            </td>
