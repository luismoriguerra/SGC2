...
<html>
	<head>
		...
		<script type="text/javascript" src="../javascript/dao/DAOinstitucion.js"></script>
                <script type="text/javascript" src="../javascript/js/js-mant_asist_reg.js"></script>
                <style>
			...
			<div class="cuerpo">
				<div class="secc-izq" id="secc-izq" style="width:0px;">
					<ul class="lca" style="display:none">
						<li id="cron_pag" onClick="sistema.activaPanel('cron_pag','panel_crono_pago')" class="active"><span><i class="icon-gray icon-list-alt"></i> ASISTENCIA</span></li>						
					</ul>
				</div>
				...
				<div class="secc-der" id="secc-der">
                    ...
                    <div id="panel_crono_pago" style="display:block">
    					<div class="barra1"><i class="icon-gray icon-list-alt"></i> <b>ASISTENCIA</b></div>         
                        <div class="cont-der">
							<div class="t-center">
