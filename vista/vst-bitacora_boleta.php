...
<html>
	<head>
		...
		<script type="text/javascript" src="../javascript/js/js-bitbol.js"></script>
			...
			<div class="cuerpo">
				<div class="secc-izq" id="secc-izq" style="width:0px;">
					<ul class="lca" style="display:none">
                                            <li id="list_Arqueo Caja" onclick="sistema.activaPanel('list_Arqueo Caja','panel_Arqueo Caja')" class="active"><span><i class="icon-gray icon-download"></i> Bitacora Boleta</span></li>
					</ul>
				</div>
				...
				<div class="secc-der" id="secc-der">
                    ...
                    <div id="panel_Arqueo Caja" style="display:block">
                        <form>
    					<div class="barra1 t-left"><i class="icon-gray icon-download"></i> <b>ARQUEO CAJA</b></div>         
                        <div class="cont-der">
                            ...
                            <!--<div style="display:block">
                                <span class="ui-widget-content t-12" style="padding:2px">Modificó</span>
                                <input type="text" id="txt_modifico" class="input-xlarge" onKeyPress="return sistema.validaLetras(event)">
                            ...
                            <div id="validalista" style="display:none; text-align:center">
                                ...
                                <table id="table_bitbol"></table>
                                <div id="pager_table_bitbol"></div>
                                </div>
