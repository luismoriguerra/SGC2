...
<html>
	<head>
		...
		<script type="text/javascript" src="../javascript/templates.js"></script>
         ...
         <script type="text/javascript" src="../javascript/jqGrid/JqGridMantPersona.js"></script>
        ...
        <script type="text/javascript" src="../javascript/js/js-persona3.js"></script>
			...
			<div class="cuerpo">
				...
				<div class="secc-der" id="secc-der">
                    ...
                    <div id="panel_matricula" style="display:block">
    					<div class="barra1"><i class="icon-gray icon-list-alt"></i> <b>Mantenimiento Persona(s) <? /*aqui va el titulo q presentara  */ ?></b></div>         
                            ...
                            */
							?>
                              ...
                              <div style="margin-right:3px">
                                <table id="table_persona2"></table>
                                <div id="pager_table_persona2"></div>
                              </div >                             
                            
                            <!--mantenimieto persona-->
                        ...
                        <tr>                        	
                            ...
                            <td colspan="5">
                            <input type="text" id="txt_referencia" onKeyPress="return sistema.validaAlfanumerico(event)" class="input-xxlarge" maxlength="100">
                            </td>
                        </tr>
                        <tr>
