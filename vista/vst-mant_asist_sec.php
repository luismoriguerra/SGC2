...
<html>
	<head>
		...
		<script type="text/javascript" src="../javascript/dao/DAOinstitucion.js"></script>
                <script type="text/javascript" src="../javascript/js/js-mant_asist_sec.js"></script>
                <style>
                    .au-sec-cant {
                        width: 30px;
                        }
			...
			<div class="cuerpo">
				<div class="secc-izq" id="secc-izq" style="width:0px;">
					<ul class="lca" style="display:none">
						<li id="cron_pag" onClick="sistema.activaPanel('cron_pag','panel_crono_pago')" class="active"><span><i class="icon-gray icon-list-alt"></i> Sección</span></li>						
					</ul>
				</div>
				...
				<div class="secc-der" id="secc-der">
                    ...
                    <div id="panel_crono_pago" style="display:block">
    					<div class="barra1"><i class="icon-gray icon-list-alt"></i> <b>SECCIÓN</b></div>         
                        <div class="cont-der">
							<div class="t-center">
               ...
               <div id="alu_listado" style="display:none">
                   ...
                   <div class="auto-asig">
                       ...
                       <a id="btnAsignarAuto" class='btn btn-azul sombra-3d t-blanco'  ><i class='icon-white  icon-list'></i> Asignar Secciones</a>
                           ...
                           <br>
                           <div class="auto-totales" style="text-align:left;">
                               <div> <b>Total de registros: </b><span id="alu-total"></span></div>
                               <div> <b>Registros x Asign: </b><span id="alu-falta"></span></div>
                           </div>
                       </div>
                   </div>
                   <br>
                   <table class="listado_alumnos">
                       ...
                       <tr>
                           ...
                           <th class="t-center label">CEL / TEL</th>                          
               ...
               <div id="wrap_iu_asist" style="display:none">
                   ...
                   <table class="iu_asist" border="1">
                       <tr class='iu_asis_cab'>
                           <th class="t-center label">NRO</th>
                           <th class="t-center label">APELLIDOS Y NOMBRES</th>
                           <th class="t-center label">TELEFONO</th>
                       </tr>
                   </table>
                   <div>
