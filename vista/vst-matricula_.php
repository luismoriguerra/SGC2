			...
			<div class="cuerpo">
				...
				<div class="secc-der" id="secc-der">
                    ...
                    <div id="panel_matricula" style="display:block">
    					<div class="barra1"><i class="icon-gray icon-list-alt"></i> <b>FICHA DE MATRICULA</b></div>         
                        <div class="cont-der">
                            ...
                            <div id="form_matricula" style="width:1000px;border:1px solid #ccc;margin:0px auto;padding:10px 0px;" class="t-center">
                                ...
                                <div style="display:inline-block;width:800px;" class="t-center">
                                    <table>
                                        <tr>
                                            ...
                                            <td class="t-left label t-negrita">Nro Ficha Matrícula:</td>
                                            <td class="t-left">SERIE<input type="text" onKeyPress="return sistema.validaAlfanumerico(event)" id="txt_cod_fic_mat1" maxlength="3" class="input-mini">&nbsp;NRO<input type="text" onKeyPress="return sistema.validaAlfanumerico(event)" id="txt_cod_fic_mat2" maxlength="8" class="input-mini"></td>                                            
                                        </tr>
                                    </table>
                                </div>
                                <div>
                                    <div style="width:49.8%;display:inline-block;">
                                        <table style="width:80%">
                                            <tr>
                                                <td class="t-left label" width="45%">Ficha de Inscripción:</td>                                                
                                        ...
                                        <div>
                                            <table style="width:80%">
                                                <tr>
                                                    ...
                                                    <td><input type="text" maxlength="12" onKeyPress="return sistema.validaAlfanumerico(event)" id="txt_cod_univers" style="width:96%"></td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="text" id="txt_email" style="width:96%" disabled></td>
                                                </tr>
                                                <tr>
                                                    <td class="t-left label" width="45%">Celular:</td>
                                                    <td><input type="text" id="txt_celular" style="width:96%" disabled></td>
                                                </tr>
                                                <tr>
                                                    <td class="t-left label" width="45%">Tel. Casa/Trab.:</td>
                                                    <td><input type="text" id="txt_tel_casa_trab" style="width:96%" disabled></td>
                                                </tr>
                                            </table>
                                        </div>
                                    </div>
                                ...
                                <div>
                                    <div class="barra4 contentBarra t-blanco t-left"><i class="icon-white icon-th"></i>DATOS DEL DOMICILIO Y  TRABAJO (SOLO ALUMNOS ANTIGUOS)</div>
                                    <div>
                                    ...
                                    <div>
                                        <table style="width:100%">
                                            <tr>
                                                ...
                                                <td class="t-left" width="27%"><input type="text" onKeyPress="return sistema.validaAlfanumerico(event)" id="txt_cod_cert_est" style="width:96%"></td>
                                                <td class="t-left label" width="23%">CÓD. Partida de Nacimiento:</td>
                                                <td class="t-left"><input type="text" onKeyPress="return sistema.validaAlfanumerico(event)" id="txt_cod_part_nac" style="width:96%"></td>
                                            </tr>
                                            <tr>
