...
<html>
	<head>
		...
		<script type="text/javascript" src="../javascript/js/js-re_inscripcion.js"></script>
			...
			<div class="cuerpo">
				<div class="secc-izq" id="secc-izq" style="width:0px;">
					<ul class="lca" style="display:none">
						<li id="list_inscripcion" onClick="sistema.activaPanel('list_inscripcion','panel_inscripcion')" class="active"><span><i class="icon-gray icon-list-alt"></i> Ficha ReInscripción </span></li>						
					</ul>
				</div>
				<div id="secc-divi" class="secc-divi secc-divi-izq"><i class="icon-white icon-der"></i></div>
				<div class="secc-der" id="secc-der">
					<div id="panel_inscripcion" style="display:block">
						<div class="barra1"><i class="icon-gray icon-list-alt"></i> <b>FICHA DEL REINSCRIPCIÓN DEL ALUMNO RETIRADO</b></div>         
					  <div class="cont-der">
                       <table style="width:1000px;" align="center"><tr><td>
                       <div class="barra4 contentBarra t-blanco"><i class="icon-white icon-th"></i>ALUMNO QUE TIENE DEVOLUCION POR RETIRO EN ESTADO PENDIENTE</div>
                        <br>
                        <TABLE class="t-left">
                        <tr>
                        	<td class="ui-state-default" width="150px"><span class="t-rojo">*</span>Persona Seleccionada:</td>
                            <td>
                            	<input type="text" id="txt_persona_person" class="input-large" disabled>                                
                            </td>                            
                        </tr>
                        <tr>
                        	<td class="ui-state-default" width="150px"><span class="t-rojo">*</span>Monto Seleccionado:</td>
                            <td>
                            	<input type="text" id="txt_nmonrec_concepto" onKeyPress="return sistema.validaAlfanumerico(event)" class="input-mediun" disabled>
                                <input type="hidden" id="txt_cconcep_concepto" value="">
                                <input type="hidden" id="txt_persona_elegida" value="">
                            </td>                            
                        </tr>                        	
                        <tr>
                        	<td colspan="2">
                              <div style="margin-right:3px">
                                <table id="table_jqgrid_concep"></table>
                                <div id="pager_table_jqgrid_concep"></div>
                              </div >                             
                            </td>
                        </tr>
                        </tr>
                    ...
                    <div>
                        ...
                        <tr>
                            ...
                            <td ><input type="text" id="txt_monto_pagado_ins" onKeyUp="ValidaMontoPagadoIns();" onBlur="validaRestoPago('_ins');" onKeyPress="return sistema.validaNumeros(event)" class="input-medium" disabled></td>
                        </tr>
                        <tr>
                        ...
                        <tr class="escondeespecial" style="display:">
                        ...
                        <tr class="escondeespecial" id="val_boleta_ins" style="display:none">
                        ...
                        <tr class="escondeespecial" id="val_voucher_ins" style="display:none">
                        ...
                        <div class="t-center">
                            ...
                            <table>                                
                                ...
                                <tr>
                                    ...
                                    <td class="t-left"><input type="text" id="txt_monto_pagado" onKeyUp="ValidaMontoPagado();" onBlur="validaRestoPago('');" onKeyPress="return sistema.validaNumeros(event)" class="input-medium" disabled></td>
                                </tr>
                                <tr>
                                ...
                                <tr class="escondeespecial" id="val_boleta" style="display:none">
                                ...
                                <tr class="escondeespecial" id="val_voucher" style="display:none">
                        ...
                        <div class="t-center">
                            ...
                            <table>
                                ...
                                <tr>
                                    <td class="ui-state-default">Monto Pagado:</td>
                                    <td class="t-left"><input type="text" id="txt_monto_pagado_pension" onKeyUp="ValidaMontoPagadoPension();" onBlur="validaRestoPago('_pension');" onKeyPress="return sistema.validaNumeros(event)" class="input-medium" disabled></td>
                                </tr>
                                <tr>
                                    <td class="ui-state-default">Monto Deuda:</td>
                                ...
                                <tr class="escondeespecial" id="val_boleta_pension" style="display:none">
                                    <td class="ui-state-default">Serie Boleta:</td>
                                ...
                                <tr class="escondeespecial" id="val_voucher_pension" style="display:none">
                                    <td class="ui-state-default">Nro Voucher:</td>
                        ...
                        <div class="t-center">
                            ...
                            <table style="display:none" id="valida_pago_convalidacion" class="t-left">
                                ...
                                <tr class="escondeespecial" id="val_boleta_convalida" style="display:none">
                                    <td class="ui-state-default">Serie Boleta:</td>
                                ...
                                <tr class="escondeespecial" id="val_voucher_convalida" style="display:none">
                                    <td class="ui-state-default">Nro Voucher:</td>
