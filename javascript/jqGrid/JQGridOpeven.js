var jQGridCencap={
    ...
    Cencap: function(){
        ...
        {name:'ntelefo',index:'ntelefo',align:'left',width:120,editable:true,editrules:{required:true},sorttype:"text"},
        ...
        {name:'cinstit',index:'ctipcap',align:'left',width:120,editable:true,editrules:{required:true},sorttype:"text",hidden:true}, 
        {name:'dinstit',index:'dinstit',align:'left',width:120,editable:true,editrules:{required:true},sorttype:"text"},
        {name:'ctelefono',index:'ctelefono',align:'left',width:120,editable:true,editrules:{required:true},sorttype:"text"},
        {name:'ccelular',index:'ccelular',align:'left',width:120,editable:true,editrules:{required:true},sorttype:"text"},
