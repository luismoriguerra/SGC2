var jqGridPersona={
	...
	promotor:function(){
		var gridTU=$('#table_promotor').jqGrid({
			...
			gridview:true,
			height:232,
			colNames:['Paterno','Materno','Nombres','DNI','demail','telefono','tipo_documento','sexo','cod_dpto','cod_prov','cod_dist','direccion','fecha_gn:','codigo_interno','codigo_instituto','tipo_vendedor'],
			colModel:[				
				...
				{name:'fretven',index:'fretven',align:'left',width:10,hidden:true},
	...
	jqgridVended:function(){
		var gridTU=$('#table_jqgrid_vended').jqGrid({
			...
			gridview:true,
			height:232,
			colNames:['COD INT','Paterno','Materno','Nombres','DNI','demail','telefono','tipo_documento','sexo','cod_dpto','cod_prov','cod_dist','direccion','fecha_ingreso','fecha_retiro','codigo_instituto','tipo_vendedor','Estado',"copeven"],
			colModel:[
