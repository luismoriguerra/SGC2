...
Exportar=function(){
    ...
    var fechinidig=$("#txt_fecha_inicio_dig").val();
    var fechfindig=$("#txt_fecha_fin_dig").val();
    window.location='../reporte/excel/EXCELcontrolpago_m2.php?cfilial='
                    +cfilial+'&cinstit='+cinstit+'&usuario='+$('#hd_idUsuario').val()+'&fechini='+fechini+'&fechfin='+fechfin+'&fechinidig='+fechinidig+'&fechfindig='+fechfindig+'&orden=g.cfilial,g.cinstit,ca.dcarrer';
	}
}