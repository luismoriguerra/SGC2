...
Visualizar=function(){
    if(validar_fechas()){
        ...
        $("#table_bitbol").jqGrid('setGridParam',{url:'../controlador/controladorSistema.php?comando=reporte&accion=jqgrid_bitbol&finicio='+$("#txt_fechaInicio").val()+'&ffin='+$("#txt_fechaFin").val()+'&serbol='+$("#txt_serie_boleta").val()+'&nrobol='+$("#txt_nro_boleta").val()}); 
		$("#table_bitbol").trigger('reloadGrid');
    }    
}
...
Exportar=function(){
	...
	window.location='../reporte/excel/EXCELbitbol.php?finicio='+f_ini+'&ffin='+f_fin+"&dfilial="+dfilial+"&nrobol="+nrobol+"&serbol="+serbol;	
    }    
}