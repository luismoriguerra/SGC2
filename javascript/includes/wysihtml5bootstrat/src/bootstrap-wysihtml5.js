!function($, wysi) {
    ...
    var templates = {
        ...
        "emphass":    "<li>" +
                           "<div class='btn-group'>" +
                               "<a class='btn' data-wysihtml5-command='bold' title='CTRL+B'>N</a>" +
                               "<a class='btn' data-wysihtml5-command='italic' title='CTRL+I'>K</a>" +
                               "<a class='btn' data-wysihtml5-command='underline' title='CTRL+U'>S</a>" +
                           "</div>" +
                       "</li>",
        "lists":       "<li>" +
                           "<div class='btn-group'>" +
